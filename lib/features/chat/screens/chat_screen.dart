            ...
            children: [
              ...
              _ChatInputBar(
                ...
                onSend: (text) {
                  ...
                  ref.read(messagesProvider.notifier).sendMessage(newMessage);
...
class _MessageBubble extends StatelessWidget {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildContent(message, isMe, colorScheme),
  ...
  Widget _buildContent(MessageModel message, bool isMe, ColorScheme colorScheme) {
    switch (message.type) {
      case MessageType.text:
        return Padding(
          ...
          child: Text(
            message.text ?? '',
            style: TextStyle(color: isMe ? colorScheme.onPrimary : colorScheme.onSurface, fontSize: 15),
          ),
        );
          ...
          children: [
            Expanded(
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Replying to ${message.isMe ? 'yourself' : 'John Doe'}', style: TextStyle(color: colorScheme.primary, fontWeight: FontWeight.bold, fontSize: 13)),
...
class _ChatInputBarState extends ConsumerState<_ChatInputBar> {
  ...
  Widget _buildRecordingUI(ColorScheme colorScheme) {
    return Row(
      children: [
        ...
        const SizedBox(width: 8),
        Text('0:01', style: TextStyle(color: colorScheme.onSurface, fontWeight: FontWeight.bold)),
        const Expanded(child: Center(child: Text('Slide to cancel', style: TextStyle(color: Colors.grey)))),
      ],
    );
  }
      ...
      builder: (context) {
        return Container(
          ...
          child: GridView.count(
            ...
            shrinkWrap: true,
            children: [
              _buildAttachItem(Icons.camera_alt, 'Camera', Colors.pink, colorScheme),
              _buildAttachItem(Icons.image, 'Gallery', Colors.purple, colorScheme),
              _buildAttachItem(Icons.insert_drive_file, 'Document', Colors.indigo, colorScheme),
              _buildAttachItem(Icons.location_on, 'Location', Colors.green, colorScheme),
              _buildAttachItem(Icons.person, 'Contact', Colors.blue, colorScheme),
            ],
          ),
        );
      },
  ...
  Widget _buildAttachItem(IconData icon, String label, Color color, ColorScheme colorScheme) {
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Container(
