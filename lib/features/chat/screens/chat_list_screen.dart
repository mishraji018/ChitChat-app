...
class _ChatListScreenState extends ConsumerState<ChatListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          if (isSearchExpanded) _buildSearchBar(theme, colorScheme),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        elevation: 8,
        child: Icon(Icons.edit, color: theme.floatingActionButtonTheme.foregroundColor),
      ),
    );
  }
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isSelected ? Colors.transparent : colorScheme.secondary.withValues(alpha: 0.3),
                    width: 1,
                  ),
                ),
  ...
  Widget _buildChatTile(ChatModel chat, ThemeData theme, ColorScheme colorScheme) {
    ...
    return Slidable(
      ...
      startActionPane: ActionPane(
        ...
        children: [
          SlidableAction(
            onPressed: (context) {
              ref.read(chatListProvider.notifier).archiveChat(chat.id);
            },
      ...
      child: InkWell(
        ...
        onLongPress: () {
          if (!isSelectionMode) {
            ...
            ref.read(selectedChatsProvider.notifier).state = {chat.id};
          }
        },
        child: Container(
          height: 72,
          padding: const EdgeInsets.symmetric(horizontal: 16),
          color: isSelected ? colorScheme.surface.withValues(alpha: 0.5) : Colors.transparent,
          child: Row(
            children: [
              if (isSelectionMode)
                Padding(
                      ...
                      children: [
                        if (chat.isPinned)
                          Padding(
                            ...
                            child: Icon(Icons.push_pin, color: colorScheme.secondary.withValues(alpha: 0.4), size: 14),
                          ),
                        Expanded(
                          child: Text(
                            chat.name,
                        ...
                        if (chat.isMuted)
                          Padding(
                            ...
                            child: Icon(Icons.volume_off, color: colorScheme.secondary.withValues(alpha: 0.4), size: 14),
                          ),
